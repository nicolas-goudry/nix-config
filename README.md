...
> [!TIP]
> For convenience, `nh-host build` is also available as `build-host` and `nh-host switch` is also available as `switch-host`.
...
> [!TIP]
> For convenience, `nh-home build` is also available as `build-home` and `nh-home switch` is also available as `switch-home`.
...
> [!TIP]
> For convenience, `nh-all build` is also available as `build-all` and `nh-all switch` is also available as `switch-all`.
...
- function inputs: attribute set described above
- inputs: flake inputs (useful for consuming input modules for Home Manager)
- outputs: flake outputs (useful for consuming [custom modules][section-modules] for Home Manager)
...
- function inputs: attribute set described above
- inputs: flake inputs (useful for consuming input modules for NixOS)
- outputs: flake outputs (useful for consuming [custom modules][section-modules] for NixOS)
- predicates: is it an ISO, a workstation, …
